...
if g:kolor_italic==0
  ...
  h=NONE       gui=bold
  highlight ModeMsg         guifg=#e2e2ene   guibg=NONE       gui=bold
  highlight CursorLineNr    guifgui=none
else
...
if &t_Co > 255
  ...
  highlight StatusLine      ctermf  guifg=#e2e2ene   guibg=NONE       gui=bold
  highlight Curs    ctermfg=247     ctermbg=238     cterm=none
  ...
  if g:kolor_bold==0
    ...
    highlighhlight Comment         ctermfg=244     ctermbg=none    cterm=    highlight WarningMsg      ctermfg=206     ctermbg=none    cterm=none
